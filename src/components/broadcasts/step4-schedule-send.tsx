    ...
    async function calculateReach() {
      ...
      try {
        ...
        if (audience.type === 'all') {
          ...
          const { data } = await supabase.from('contact_list_members').select('contact_id').eq('list_id', audience.listId);
          setEstimatedReach(new Set((data ?? []).map((r) => r.contact_id)).size);
